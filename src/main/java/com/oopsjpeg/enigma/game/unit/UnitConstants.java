...
public class UnitConstants
{
    ...
    public static final int ASSASSIN_SLASH_ENERGY_COST = 25;
    ...
    public static final int ASSASSIN_GOUGE_ENERGY_COST = 25;
    ...
    public static final float WARRIOR_PASSIVE_AP_RATIO = .25f;
    public static final float WARRIOR_BASH_AP_RATIO = .25f;
    public static final float WARRIOR_BASH_SP_RATIO = .3f;
    public static final int WARRIOR_BASH_COOLDOWN = 2;

    // Gunslinger
    public static final float GUNSLINGER_PASSIVE_AP_RATIO = .2f;

    public static final int GUNSLINGER_BARRAGE_COOLDOWN = 3;
    public static final int GUNSLINGER_BARRAGE_ENERGY_COST = 25;
    ...
    public static final float GUNSLINGER_BARRAGE_SP_RATIO = 0.30f;

    public static final float GUNSLINGER_ROLL_DODGE = 0.35f;
    ...
    public static final int GUNSLINGER_DEADEYE_ENERGY_COST = 50;
